  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        tag: 'Tooling',
        name: 'parsec',
        lang: 'go · simlog.NewRunReader',
        // prettier-ignore
        code: [
          ['com', '// go get, then point it at a results directory\n'],
          ['', '$ '], ['fn', 'go'], ['', ' get github.com/galax-io/parsec\n\n'],
          ['key', 'import'], ['', ' '], ['str', '"github.com/galax-io/parsec/gatling/simlog"'], ['', '\n\n'],
          ['', 'rd, _ := simlog.'], ['fn', 'NewRunReader'], ['', '(f)\n'],
          ['', 'run    := rd.'], ['fn', 'Run'], ['', '()  '], ['com', '// tool, version, warnings\n\n'],
          ['key', 'for'], ['', ' {\n'],
          ['', '  item, err := rd.'], ['fn', 'Next'], ['', '()  '], ['com', '// model.Item, until io.EOF\n'],
          ['', '  ...\n'],
          ['', '}\n\n'],
          ['com', '// Gatling text 3.11.5-3.12.0 · binary 3.13.1-3.15.1, version-gated\n'],
